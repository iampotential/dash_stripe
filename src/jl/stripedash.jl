...
function stripedash(; kwargs...)
        available_props = Symbol[:id, :amount, :customConfirmMessage, :errorMessage, :label, :paymentIntentId, :paymentMethodDetails, :paymentMethodId, :paymentStatus, :prePaymentMessage, :referenceId, :stripe_api, :stripe_key]
        wild_props = Symbol[]
